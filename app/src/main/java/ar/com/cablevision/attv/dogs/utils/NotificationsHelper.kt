package ar.com.cablevision.attv.dogs.utils
...
import ar.com.cablevision.attv.dogs.view.MainActivity
...
class NotificationsHelper(val context: Context) {
    ...
    fun createNotification() {
        ...
        val intent = Intent(context, MainActivity::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_TASK_ON_HOME or Intent.FLAG_ACTIVITY_CLEAR_TASK
        }
